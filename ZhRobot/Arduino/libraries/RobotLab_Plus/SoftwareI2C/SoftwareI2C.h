...
private:
  ...
  // private methods
  void setPins(int16_t sdaPin, int16_t sclPin, uint8_t usePullups);
...
public:
  // public methods
  SoftwareI2C(int16_t sdaPin=13, int16_t sclPin=11);
  SoftwareI2C(int16_t sdaPin, int16_t sclPin, uint8_t usePullups);
